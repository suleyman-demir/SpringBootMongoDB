package com.school.management.mongo.controller;


import com.school.management.mongo.dto.LessonDto;
import com.school.management.mongo.service.LessonService;
...
public class LessonController {
    ...
    public ResponseEntity<LessonDto> getAllDetailsOfLesson(@RequestParam String lessonId) {
        logger.info("Received request to get all details of lesson with ID: {}", lessonId);
